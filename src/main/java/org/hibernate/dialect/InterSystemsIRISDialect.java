...
public class InterSystemsIRISDialect extends Dialect {
	...
	private static final LimitHandler IRISLimitHandler = new AbstractLimitHandler() {
		...
		public String processSql(String sql, RowSelection selection) {
			...
			// extensions, but this extension is not supported by Hibernate either.
	...
	/**
	 * Creates new <code>InterSystemsIRISDialect</code> instance. Sets up the JDBC / IRIS type mappings.
	 */
	...
	public LockingStrategy getLockingStrategy( Lockable lockable, LockMode lockMode ) {
		...
		// InterSystems IRIS doesn't really support this.
	...
	/**
	 * The InterSystems IRIS ViolatedConstraintNameExtracter.
	 */
	...
	/**
	 * E.g. "select count(distinct a,b,c) from hasi" isn't supported
	 */
	@Override
